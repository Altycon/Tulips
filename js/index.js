...
import { ROOM,addRoomListeners } from "./room.js";
import { addVideoButtonListeners } from "./Video/controls.js";
import { addNotificationToChatWindow } from "./Chat/chat-utilities.js";
...
function initializeRoom(){
    addNotificationToChatWindow('You have entered the room');
    addRoomListeners();
    addVideoButtonListeners();

    console.log(ROOM.isMobile)
}
